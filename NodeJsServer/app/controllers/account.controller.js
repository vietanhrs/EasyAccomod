	...
	if (result.length !== 0) {
	    ...
	    try {
	        ...
	        const account = {
	            ...
	            password: bcrypt.hashSync(accountData.password, 10),
...
exports.getUserInfo = async (req, res) => {
	...
	const results = await sequelize.query(
		`SELECT username, fullName, idCard, phoneNumber, email, address, online FROM users JOIN accounts ON users.idCard = accounts.userIdCard WHERE username = :username`,
